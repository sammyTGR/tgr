      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            This is an automated reminder that you have been clocked in for over
            9 hours.
          </Text>
          <Text style={paragraph}>
          ...
          <Text style={paragraph}>
            Please clock out as soon as possible AND contact your supervisor
            IMMEDIATELY to correct your schedule.
          </Text>
          <Hr style={hr} />
