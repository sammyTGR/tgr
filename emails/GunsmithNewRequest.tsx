  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>A new request has been submitted for the following firearm:</Text>
        <Text style={text}>
        ...
        <Hr style={hr} />
        <Text style={text}>Please review this request and take appropriate action.</Text>
