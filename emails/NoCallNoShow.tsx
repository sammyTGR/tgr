    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            This email confirms that {name} has been marked as No Call No Show for their shift on{' '}
            {date}.
          </Text>
          <Hr style={hr} />
          <Text style={text}>
            If this is an error or you need to discuss this further, please contact your manager
            immediately.
          </Text>
