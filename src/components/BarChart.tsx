...
const ChartTooltipRow = ({ value, name, color }: ChartTooltipRowProps) => (
  <div className="flex items-center justify-between space-x-8">
    <div className="flex items-center space-x-2">
      <span aria-hidden="true" className={cx('size-2 shrink-0 rounded-sm', color)} />
      <p
        className={cx(
          // commmon
...
interface BarChartProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  legendPosition?: 'left' | 'center' | 'right';
  xAxisProps?: object; // Added xAxisProps
  yAxisProps?: object; // Added yAxisProps
}
...
const BarChart = React.forwardRef<HTMLDivElement, BarChartProps>((props, forwardedRef) => {
  const {
    ...
    xAxisProps = {}, // Default value for xAxisProps
    yAxisProps = {}, // Default value for yAxisProps
    ...other
  } = props;
      ...
      <ResponsiveContainer>
        ...
        >
          ...
          <XAxis
            ...
            {...xAxisProps} // Add xAxisProps here
          >
            {xAxisLabel && (
              <Label
          ...
          <YAxis
            ...
            {...yAxisProps} // Add yAxisProps here
          >
            {yAxisLabel && (
              <Label
                position="insideLeft"
