...
export function TermEmployeeDialog({ isOpen, onClose, employee, onTerm }: TermEmployeeDialogProps) {
  ...
  const termMutation = useMutation({
    ...
    onError: (error) => {
      ...
      toast.error('Termination Failed', {
        description: 'There was an error terminating the employee. Please try again.',
      });
    },
  });
