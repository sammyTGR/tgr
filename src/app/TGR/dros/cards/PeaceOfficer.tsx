    ...
    <div className="flex flex-col items-center justify-center w-[515px]">
      <Card className="flex flex-col w-full">
        <CardHeader>
          ...
          <CardDescription>
            There Are A Couple Ways To Understand If The Officer Is A Peace Officer, Or A Public
            Officer
            <br />
            You Will Need To Scan The Front And Rear Of Their Department ID Card (Including ID
