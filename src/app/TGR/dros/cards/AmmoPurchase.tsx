    ...
    <div className="flex flex-col items-center justify-center w-[515px]">
      <Card className="flex flex-col w-full">
        <CardHeader>
          ...
          <CardDescription>
            Customer Must Have Purchased A Firearm Within The Last 5 Years At
          ...
          <Tabs defaultValue="" className="w-full">
            <TabsList className=" grid grid-cols-2 mb-4">
              ...
              <TabsTrigger value="oos">
                Out Of State Military (ACTIVE DUTY WITH PCS)
              </TabsTrigger>
            </TabsList>
            <TabsContent value="address">
              <div className="flex flex-col w-full">
                <h2>
                  If The Address On CA DL | ID Is{" "}
                  <span className="text-red-500">NOT</span> Current, One Of The
                  Following Docs Can Be Used For Address Correction:
                </h2>
                <ul className="list-disc pl-4">
                  ...
                  <li>
                    Along With Any Other Doc Listed In &quot;Address Correction
                    Docs&quot;
                  </li>
                </ul>
              </div>
            ...
            <TabsContent value="federal">
              <div className="max-w-full">
                ...
                <p>
                  These Will Be{" "}
                  <span className="text-amber-500">IN ADDITION TO</span> A Valid
                  CA ID | DL
                </p>
              </div>
              <hr className="my-4" />
            ...
            <TabsContent value="oos">
              <div className="flex flex-col w-full">
                ...
                <p>
                  Since We Cannot Photocopy Their Military ID - Write Down DOD
                  ID#, Rank & Branch On{" "}
                  <span className="text-orange-500">
                    Federal Worksheet (Link Below)
                  </span>{" "}
                </p>
                <p>
                  <span className="text-red-500">DO NOT USE</span> Any Other
                  Address Other Than What&apos;s Listed On Their ID | DL
                </p>
                <hr className="my-4" />
                <p>
                  If The Customer States They Went To Another Shop & They
                  Utilized A Different Address, Direct The Customer To The CFARS
                  Website To Update Their Address (Link Found Below)
                  <hr className="my-4" />
                  We Must <span className="text-red-500">
                    ALWAYS & ONLY
                  </span>{" "}
                  Process Their DROS With The Address On Their ID | DL
                </p>
              </div>
            </TabsContent>
              ...
              <div className="flex flex-col w-full">
                <h2>
                  <span className="text-amber-500">
                    Start By Selecting &quot;Peace Officer Non-Roster Handgun
                    Sale (Letter Required)&quot;
                  </span>
                </h2>
                <hr className="my-4" />
                <ul className="list-none pl-4">
