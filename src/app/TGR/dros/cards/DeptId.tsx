    ...
    <div className="flex flex-col items-center justify-center w-[515px]">
      <Card className="flex flex-col w-full">
        <CardHeader>
          ...
          <CardDescription>
            Check For Validity Dates & P.C. 832 | &quot;Sworn Officer&quot;
            Typically Located On The Back Of The Department ID Cards
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex justify-between">
          <p>
            ...
            Accept Department ID&apos;s If They Don&apos;t Match The
            Requirements - They Will Have To Get A Replacement Department ID
          </p>
        </CardFooter>
      </Card>
    </div>
