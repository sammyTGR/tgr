      ...
      <Card className="flex flex-col w-full">
        <CardHeader>
          ...
          <div className="max-w-full">
            The ATF Requires A Valid Photo ID Along With One Other Valid Government-Issued Document That Shows The Current Address
            The Following Are Accepted Documents, And Can Be Combined To Meet The Requirements</div></CardDescription>
        </CardHeader>
        <CardContent>
        <div className="max-w-full">
