    ...
    <div className="flex flex-col items-center justify-center w-full">
      <Card className="flex flex-col w-full">
        ...
        <CardContent>
          <div className="max-w-[425px]">
            ...
            <ul className="list-disc pl-4">
              <li>
                DHS Arrival | Departure Record Issued To Travelers Who Are Adjusting Status While In
                USA, Or Extending Status, Among Other Uses
              </li>
        ...
        <CardFooter className="flex justify-between">
          <HoveredLink href="https://utfs.io/f/bedee236-4c7e-4272-b484-63447fa5bd41-1im1.jpg">
            <span className="text-orange-500">Work VISA Photo</span>
          </HoveredLink>
        </CardFooter>
      </Card>
    </div>
