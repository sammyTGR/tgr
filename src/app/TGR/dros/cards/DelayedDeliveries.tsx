    ...
    <div className="flex flex-col items-center justify-center w-[515px]">
      <Card className="flex flex-col w-full">
        <CardHeader>
          ...
          <CardDescription>
            Follow These Steps To Process A Delayed Delivery & Release Out Of
            Fastbound
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="max-w-full">
            <h2>
              Deliverying An Undetermined | Approval After Delay Out Of
              Fastbound:
            </h2>
            <br />
            <ul className="list-none pl-4">
              ...
              <ul className="list-none pl-4">
                <li>
                  In State Of CA, DOJ Submits All NICS FBI Background Checks, We
                  Are To Utilize The Dros Number In Place Of The Nics Number
                </li>
              </ul>
              {/* Nested list item */}
              <hr className="my-4" />
              <li>
                27.c. Only “Delayed” Should Be Marked Here, Do Not Enter A Date
                For The “Firearms May Be Transferred On” Entry Field.
              </li>
              <ul className="list-none pl-4">
                <li>
                  This Question Is Asking For A Date To Be Entered If The
                  “Delayed Delivery” Notice Specifies A Date That We Are Given
                  As The Release Date (This Has Yet To Happen)
                </li>
              </ul>
              {/* Nested list item */}
              <hr className="my-4" />
            ...
            <span className="text-red-500">
              REMEMBER TO DISPOSE THE FIREARM AFTER YOU SEND THE 4473 TO THE
              CLOUD!
            </span>
          </div>
        </CardContent>
