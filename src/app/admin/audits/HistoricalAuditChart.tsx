...
export function HistoricalAuditChart({ data, selectedLanid }: HistoricalChartProps) {
  ...
  const chartData = React.useMemo(() => {
    ...
    const employeeData = data.filter((audit) => audit.salesreps === selectedLanid);
    ...
    <Card className="mt-6">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          ...
          <CardDescription>Historical audit metrics for {selectedLanid}</CardDescription>
        </div>
        ...
        <div className="h-[350px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
              <defs>
                <linearGradient id="historicalMinor" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#3B82F6" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="#3B82F6" stopOpacity={0.1} />
                </linearGradient>
                <linearGradient id="historicalMajor" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#EAB308" stopOpacity={0.8} />
                  <stop offset="95%" stopColor="#EAB308" stopOpacity={0.1} />
                </linearGradient>
                <linearGradient id="historicalCancelled" x1="0" y1="0" x2="0" y2="1">
