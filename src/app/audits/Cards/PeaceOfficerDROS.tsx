  ...
  const router = useRouter();
    ...
    return (
        ...
        <Card className="flex flex-col w-full">
            ...
            <CardDescription>
                Scan The Front AND Rear Of Department ID Card (Including ID Number)<br/>
                <br/>
                ...
                <hr className="my-4" />
                <span className="text-red-500">We Can NO LONGER Accept 10 Day Wait Exemption Letters For CDCR</span>
