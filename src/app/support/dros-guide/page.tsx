  ...
  const sections = [
    {
      ...
      content: `To enter an audit:
        • First navigate to the audit management page by hovering over the "Auditing" tab in the navigation bar then clicking on "DROS Guidance" for admins or "DROS Guide" for all other users
        • Click the "DROS Guide" tab in the page tabs list
